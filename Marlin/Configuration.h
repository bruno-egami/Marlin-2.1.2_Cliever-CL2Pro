...
#define STRING_CONFIG_H_AUTHOR "(Bruno Egami)" // Who made the changes.
...
// #define BAUDRATE_2 250000   // :[2400, 9600, 19200, 38400, 57600, 115200,
// 250000, 500000, 1000000] Enable to override BAUDRATE
...
// #define BAUDRATE_3 250000   // :[2400, 9600, 19200, 38400, 57600, 115200,
// 250000, 500000, 1000000] Enable to override BAUDRATE
...
#define CUSTOM_MACHINE_NAME "Franck CL2"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "12366f67-8b8d-41ed-9165-b3a5860b222b"
 ...
 * 'TMC2208_STANDALONE', 'TMC2209', 'TMC2209_STANDALONE', 'TMC26X',
...
// M166 and LCD #define MIXING_PRESETS         // Assign 8 default V-tool
// presets for 2 or 3 MIXING_STEPPERS
...
// PSU to warm up to full power #define LED_POWEROFF_TIMEOUT 10000    // (ms)
// Turn off LEDs after power-off, with this amount of delay

// #define POWER_OFF_TIMER               // Enable M81 D<seconds> to power off
// after a delay #define POWER_OFF_WAIT_FOR_COOLDOWN   // Enable M81 S to power
// off only after cooldown
...
// PSU on if the cooler is over this temperature
#endif
#endif
...
/**
 * --NORMAL IS 4.7kΩ PULLUP!-- 1kΩ pullup can be used on hotend sensor, using
 ...
 *                  NOTE: You must uncomment/set the MAX31865_*_OHMS_n defines
 * below. -3 : MAX31855 with Thermocouple, -200°C to +700°C (only for sensors
 * 0-1) -2 : MAX6675  with Thermocouple, 0°C to +700°C    (only for sensors 0-1)
 *
 ...
 * silicone mats, most Wanhao i3 machines - beta 3950, 1% 12 : 100kΩ  Vishay
 * 0603 SMD NTCS0603E3104FXT (#8) - calibrated for Makibox hot bed 13 : 100kΩ
 * Hisens up to 300°C - for "Simple ONE" & "All In ONE" hotend - beta 3950, 1%
 *    15 : 100kΩ  Calibrated for JGAurora A5 hotend
 *    18 : 200kΩ  ATC Semitec 204GT-2 Dagoma.Fr - MKS_Base_DKU001327
 *    22 : 100kΩ  GTM32 Pro vB - hotend - 4.7kΩ pullup to 3.3V and 220Ω to
 * analog input 23 : 100kΩ  GTM32 Pro vB - bed - 4.7kΩ pullup to 3.3v and 220Ω
 * to analog input 30 : 100kΩ  Kis3d Silicone heating mat 200W/300W with 6mm
 * precision cast plate (EN AW 5083) NTC100K - beta 3950 60 : 100kΩ  Maker's
 ...
 * Thermistor 68 : PT100 amplifier board from Dyze Design 70 : 100kΩ  bq
 * Hephestos 2 75 : 100kΩ  Generic Silicon Heat Pad with NTC100K
 * MGB18-104F39050L32 2000 : 100kΩ  Ultimachine Rambo TDK NTCG104LH104KT1
 * NTC100K motherboard Thermistor
 *
 *  Analog Thermistors - 1kΩ pullup - Atypical, and requires changing out
 * the 4.7kΩ pullup for 1kΩ.
 *  -------                           (but gives greater accuracy and more
 * stable PID) 51 : 100kΩ  EPCOS (1kΩ pullup) 52 : 200kΩ  ATC Semitec 204GT-2
 * (1kΩ pullup) 55 : 100kΩ  ATC Semitec 104GT-2 - Used in ParCan & J-Head (1kΩ
 * pullup)
 *
...
#if ENABLED(PIDTEMP)
// #define PID_DEBUG             // Print PID debug data to the serial port. Use
// 'M303 D' to toggle activation. #define PID_PARAMS_PER_HOTEND // Use separate
// PID parameters for each extruder (useful for mismatched extruders)
 ...
 * correctly this gives better responsiveness and stability than PID and it also
 * removes the need for PID_EXTRUSION_SCALING and PID_FAN_SCALING. Use M306 T to
 * autotune the model.
 * @section mpctemp
 */
#if ENABLED(MPCTEMP)
// #define MPC_EDIT_MENU                             // Add MPC editing to the
// "Advanced Settings" menu. (~1300 bytes of flash) #define MPC_AUTOTUNE_MENU //
// Add MPC auto-tuning to the "Advanced Settings" menu. (~350 bytes of flash)
...
// For one fan and multiple hotends MPC needs to know how to apply the fan
// cooling effect.
#if ENABLED(MPC_INCLUDE_FAN)
...
// #define FILAMENT_HEAT_CAPACITY_PERMM { 3.6e-3f }  // 0.0036 J/K/mm for 1.75mm
// PETG (0.0094 J/K/mm for 2.85mm PETG).
...
// #define PID_OPENLOOP          // Puts PID in open loop. M104/M140 sets the
// output power from 0 to PID_MAX #define SLOW_PWM_HEATERS      // PWM with very
// low frequency (roughly 0.125Hz=8s) and minimum state time of approximately 1s
// useful for heaters driven by a relay
...
// menu. (~700 bytes of flash) #define PID_AUTOTUNE_MENU     // Add PID
// auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)
#endif
...
// bed #define THERMAL_PROTECTION_CHAMBER // Enable thermal protection for the
// heated
//  chamber
...
// https://reprap.org/forum/read.php?152,504042 #define MARKFORGED_YX
...
// This needs to be reasonably accurate as it defines the printbed position in
// the SCARA space.
...
#define SCARA_FEEDRATE_SCALING // Convert XY feedrate from mm/s to degrees/s on
                               // the fly

// Radius around the center where the arm cannot reach
#define MIDDLE_DEAD_ZONE_R 0 // (mm)

#define THETA_HOMING_OFFSET                                                    \
  0 // Calculated from Calibration Guide and M360 / M114. See
    // http://reprap.harleystudio.co.za/?page_id=1073
#define PSI_HOMING_OFFSET                                                      \
  0 // Calculated from Calibration Guide and M364 / M114. See
    // http://reprap.harleystudio.co.za/?page_id=1073
...
// of the two wire ends are controlled by parallel axes (Y, J). Joints are
// directly mapped to axes (no kinematics).
...
#define K_MIN_ENDSTOP_INVERTING                                                \
  false // Set to true to invert the logic of the endstop.
#define U_MIN_ENDSTOP_INVERTING                                                \
  false // Set to true to invert the logic of the endstop.
#define V_MIN_ENDSTOP_INVERTING                                                \
  false // Set to true to invert the logic of the endstop.
#define W_MIN_ENDSTOP_INVERTING                                                \
  false // Set to true to invert the logic of the endstop.
...
#define K_MAX_ENDSTOP_INVERTING                                                \
  false // Set to true to invert the logic of the endstop.
#define U_MAX_ENDSTOP_INVERTING                                                \
  false // Set to true to invert the logic of the endstop.
#define V_MAX_ENDSTOP_INVERTING                                                \
  false // Set to true to invert the logic of the endstop.
#define W_MAX_ENDSTOP_INVERTING                                                \
  false // Set to true to invert the logic of the endstop.
...
#define MAX_FEEDRATE_EDIT_VALUES                                               \
  {300, 300, 10, 25} // ...or, set your own edit limits
#endif
...
#define DEFAULT_TRAVEL_ACCELERATION                                            \
  1500 // X, Y, Z acceleration for travel (non printing) moves
 ...
 * https://reprap.org/wiki/Kossel#Automatic_bed_leveling_probe Deploys by
 * touching z-axis belt. Retracts by pushing the probe down.
 */
// #define Z_PROBE_ALLEN_KEY
#if ENABLED(Z_PROBE_ALLEN_KEY)
// 2 or 3 sets of coordinates for deploying and retracting the spring loaded
// touch probe on G29, if servo actuated touch probe is not defined. Uncomment
// as appropriate for your printer/probe.
...
#define Z_PROBE_LOW_POINT                                                      \
  -50 // Farthest distance below the trigger-point to go before stopping
...
// #define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when
// probing #define PROBING_STEPPERS_OFF      // Turn all steppers off (unless
// needed to hold position) when probing (including extruders) #define
// DELAY_BEFORE_PROBING 200  // (ms) To prevent vibrations from triggering piezo
// sensors
...
#define Z_HOMING_HEIGHT 10 // (mm) Minimal Z height before homing (G28)
 ...
 * https://github.com/markniu/Bed_Distance_sensor Uses I2C port, so it requires
 * I2C library markyue/Panda_SoftMasterI2C.
 */
// #define BD_SENSOR
...
#define LCD_PROBE_Z_RANGE                                                      \
  40 // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
...
#define BED_TRAMMING_INSET_LFRB                                                \
  {60, 45, 60, 45}               // (mm) Left, Front, Right, Back insets
#define BED_TRAMMING_HEIGHT 10.0 // (mm) Z height of nozzle at leveling points
#define BED_TRAMMING_Z_HOP                                                     \
  8.0 // (mm) Z height of nozzle between leveling points
...
//
// This option increases encoder samples to filter out phantom encoder clicks
// caused by EMI noise.
//
...
//
// MKS MINI12864 V3 is an alias for FYSETC_MINI_12864_2_1. Type A/B. NeoPixel
// RGB Backlight.
//
...
//
// BigTreeTech Mini 12864 V1.0 is an alias for FYSETC_MINI_12864_2_1. Type A/B.
...
// #define ANYCUBIC_LCD_GCODE_EXT  // Add ".gcode" to menu entries for DGUS
// clone compatibility
#endif
...
// #define TFT_SHARED_SPI   // SPI is shared between TFT display and other
// devices. Disable async data transfer
#endif
...
// #define TOUCH_IDLE_SLEEP_MINS 5 // (minutes) Display Sleep after a period of
// inactivity. Set with M255 S.
...
// #define RGB_STARTUP_TEST              // For PWM pins, fade between all
// colors
...
#else
// #define NEOPIXEL2_INSERIES          // Default behavior is NeoPixel 2 in
// parallel
#endif
...
// #define NEOPIXEL_BKGD_ALWAYS_ON       // Keep the backlight on when other
// NeoPixels are off
#endif
