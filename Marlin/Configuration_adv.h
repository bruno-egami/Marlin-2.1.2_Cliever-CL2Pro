...
#define INPUT_SHAPING_Y // BK
  ...
  #define SHAPING_MAX_STEPRATE 5000  // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage. BK
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_XY 0.25       // (steps or mm) Steps or millimeter distance for each XY babystep
